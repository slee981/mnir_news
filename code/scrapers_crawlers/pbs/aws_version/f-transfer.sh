...
scp -i "~/.ssh/news-scraper-key.pem" ~/Dropbox/CodeWorkspace/python/news-article-scraper/pbs/aws_version/scrape_pbs.py ubuntu@ec2-52-91-76-117.compute-1.amazonaws.com:~/
scp -i "~/.ssh/news-scraper-key.pem" ~/Dropbox/CodeWorkspace/python/news-article-scraper/pbs/aws_version/aws-init.sh ubuntu@ec2-52-91-76-117.compute-1.amazonaws.com:~/
scp -i "~/.ssh/news-scraper-key.pem" ~/Dropbox/CodeWorkspace/python/news-article-scraper/pbs/aws_version/starter-urls.tar.gz ubuntu@ec2-52-91-76-117.compute-1.amazonaws.com:~/
...
# scp -i "~/.ssh/news-scraper-key.pem" ubuntu@ec2-52-91-76-117.compute-1.amazonaws.com:~/efs/pbs-politics.tar.gz ~/Dropbox/CodeWorkspace/python/news-article-scraper/pbs/aws_version/articles/
